...
namespace Projektni {
	...
	/// Summary for Pregled
	/// </summary>
	public ref class Pregled : public System::Windows::Forms::Form
	{
	public:
		ref class ItemData
		{
		...
		public:
			...
			{
				Naziv = gcnew String(sItem);
				Opis = gcnew String(sData);
			}
		public:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(31, 63);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->ReadOnly = true;
			this->dataGridView1->Size = System::Drawing::Size(553, 240);
			this->dataGridView1->TabIndex = 0;
			//this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Pregled::dataGridView1_CellContentClick);
			// 
			// Naziv
			// 
			...
			this->ClientSize = System::Drawing::Size(596, 346);
			this->Controls->Add(this->dataGridView1);
			this->Name = L"Pregled";
			this->Text = L"Pregled danasnjih dogadjaja";
			this->Load += gcnew System::EventHandler(this, &Pregled::Pregled_Load);
...
#pragma endregion
	private: System::Void Pregled_Load(System::Object^  sender, System::EventArgs^  e) {
		time_t t = time(0);
		std::ifstream myfile;
