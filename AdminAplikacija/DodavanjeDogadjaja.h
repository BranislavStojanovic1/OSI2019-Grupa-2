...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Location = System::Drawing::Point(106, 259);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(127, 37);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(127, 66);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(127, 97);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(127, 133);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(127, 169);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(108, 310);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(127, 215);
			...
			this->ClientSize = System::Drawing::Size(287, 361);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		std::string komentarUnmenaged = static_cast<const char*>(Marshal::StringToHGlobalAnsi(komentar).ToPointer());//novo
